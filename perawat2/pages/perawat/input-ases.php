 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Input Asesmen Keperawatan</li>
      </ol>
    </section>    
    <br />
    <div class="box box-success">
  <div class="box-header with-border">
    <h3 class="box-title"> <i class="fa fa-edit"></i> Input Asesmen Keperawatan</h3>
  ...
  <dl class="dl-horizontal">
                           ...
                           $cet=num_rows(query("SELECT no_rawat FROM pemeriksaan_ralan WHERE no_rawat='{$no_rawat}'"));
                            ...
                            <br />
                             ...
                             <a href="index.php?page=pasienrj&poli=<?php echo $poli;?>"><button type="button" class="btn btn-success  btn-xs"><i class="fa fa-step-backward"></i> Kembali <?php echo $nmpoli;?></button></a>
                             <a href="index.php?page=semua-pasien"><button type="button" class="btn btn-default btn-xs">Semua Pasien</button></a> 
                             <a href="index.php?page=pilih-poli"><button type="button" class="btn btn-info btn-xs"> Pasien Perpoli</button></a> 
							...
							if ($cet > 0){?>
                             <?php
                                ...
                                if ($insert) {
                                    redirect("index.php?page=input-asesmen&tanggal=".$_POST['tanggal']."&id={$id}");
                        ...
                        ?>
                            ...
                            <hr />
								...
								if ($poli == "U0001"){
									...
									?>
                                 <br><a href="cetak-asesmen.php?no_rawat=<?php echo $no_rawat;?>" target="_blank"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-print"></span> Assesmen Perawat </button></a> 
                                  ...
                                  <?php }else{?>
                                  <br><a href="cetak-asesmen1.php?no_rawat=<?php echo $no_rawat;?>" target="_blank"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-print"></span> Assesmen Perawat </button></a> 
