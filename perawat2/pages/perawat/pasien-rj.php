...
?>	
 <div class="content-wrapper">
  ...
  <div class="box-header with-border">
    <h3 class="box-title"> <i class="fa fa-list"></i><?php
  $query = query("SELECT kd_poli,nm_poli FROM poliklinik WHERE kd_poli = '$perpoli'"); 
            						
  while ($hasil = fetch_array($query)){
  ?> Daftar Pasien  <?php echo $hasil['nm_poli']; }?></h3>
  ...
  <table id="jadwal_dokter" class="table table-bordered data" width="100%">
                            ...
                            <?php }
								...
								echo '<h2>Tidak Ada kategori Dipilih</h2>';
							}
							?>
  </div>
  </div>
