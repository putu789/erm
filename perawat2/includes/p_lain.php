 ...
 <div class="header">
                        ...
                        <div id="panel1">
                          ...
                          <textarea name="keluhan" id="myeditor" class="form-control ckeditor" style="width:100%" placeholder="anamnesa"></textarea>
                                <br/>
                                ...
                                <tr class="g">
                                 ...
                                 <td class="g">Lainnya..</td>
										   ...
										   <textarea name="riwayat_lain" id="myeditor1" class="form-control ckeditor" style="width:100%" placeholder="riwayat"></textarea>
                                     </div>
                                     <br />
                    ...
                    <p>
               <textarea name="nutrisi" id="myeditor2" class="form-control ckeditor" style="width:100%" placeholder="nutrisi"></textarea><br>
                                        ...
                                        <input name="tgl_perawatan" type="hidden" 
                                         ...
                                         <input name="jam_rawat" type="hidden" 
                                                ...
                                                <br>
                                                 ...
                                                 <div class="header">
                            <h4>PEMERIKSAAN KHUSUS</h4>
                      </div>
                    <p>
               <textarea name="periksa_khusus" id="myeditor3" class="form-control ckeditor" style="width:100%" placeholder="periksa_khusus"></textarea><br>
                 		 <div class="header">
                       <h4>Assesment Fungsional</h4>
                        </div>
                        <p>
                 <textarea name="asesmen_fung" id="myeditor4" class="form-control ckeditor" style="width:100%" placeholder="asesmen_fung"></textarea><br>              		<div class="header">         
                            <h4>DIAGNOSA KEBIDANAN/KEPERAWATAN DAN MASALAH</h4>
						</div>
                        <p>
                  <textarea name="diag_bid" id="myeditor5" class="form-control ckeditor" style="width:100%" ></textarea><br>
 				<div class="header">         
                            <h4>PERENCANAAN DAN KEBUTUHAN</h4>
