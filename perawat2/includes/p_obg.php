                        ...
                        <div id="panel1">
                          ...
                          <textarea name="riwayat_lain" class="form-control ckeditor" style="width:100%" placeholder="riwayat"></textarea>
                               ...
                               <td colspan="3"> <label>Paritas</label>
                                ...
                                <tr>
                                            <td><input type="number" name="G"  placeholder="G" class="form-control inputAngka" style="width:100%"></td>
                                            <td><input type="number" name="P"  placeholder="P" class="form-control inputAngka" style="width:100%"></td>
                                            <td><input type="number" name="A"  placeholder="A" class="form-control inputAngka" style="width:100%"></td><td style="padding-right:10px;"><input type="number" class="form-control inputAngka" name="anak_hidup" /></td>
                                ...
                                <td colspan="2"> <label>Usia Kehamilan </label><p style="font-size:11px; color:#F00;">otomatis</p></td>
                                    ...
                                    <tr>
                                    <td style="padding-right:10px;"><input  type="text" id="datepicker" class="form-control" name="hpmt" placeholder="Pilih tanggal..."></td>  
                                    <td style="padding-right:10px;"><input type="text" id="datepicker1" class="form-control" name="hpl" placeholder="Pilih tanggal..."></td>   
                                    <td style="padding-right:10px;"><input type="number" name="usia_keh" id="umur"  placeholder="Usia Kehamilan" class="form-control" /></td>
