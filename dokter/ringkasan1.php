...
require_once('includes/config.php');
 ...
 $nama = str_replace(" ", "_", strtolower($_GET['no_rawat']));
	...
	$select = query("SELECT  a.no_rawat,a.umurdaftar,a.kd_poli,a.tgl_registrasi,b.nm_pasien,b.agama,b.pnd,b.stts_nikah,b.pekerjaan,b.namakeluarga,b.keluarga,b.pekerjaanpj,b.no_rkm_medis,b.alamat,b.jk, b.tgl_lahir,c.nm_kec, d.nm_kab, e.alergi ,e.tgl_perawatan,e.keluhan,e.pemeriksaan,e.suhu_tubuh,e.tensi,e.nadi,e.respirasi,e.tinggi,e.berat,e.gcs,e.periksa_khusus, e.asesmen_fung,e.nyeri,e.nutrisi,e.perencanaan,e.lila, e.riwayat,e.tindakan_dr,e.diagnosa_dr,e.kontrol_ul_tg, i.kd_dokter, i.nm_dokter, j.kd_poli, j.nm_poli, k.kode_brng, k.jml, k.aturan_pakai, k.no_resep, l.nama_brng FROM reg_periksa a, pasien b,kecamatan c,kabupaten d,pemeriksaan_ralan e, dokter i, poliklinik j, resep_dokter k, databarang l, resep_obat m WHERE a.kd_dokter = i.kd_dokter AND k.kode_brng = l.kode_brng AND k.no_resep = m.no_resep AND a.kd_poli = j.kd_poli AND a.no_rawat ='".$no_rawat."' AND e.no_rawat = '".$no_rawat."' AND a.no_rkm_medis = b.no_rkm_medis AND b.kd_kec = c.kd_kec AND d.kd_kab = b.kd_kab");
  ...
  <table width="100%">
    <tr >
	  ...
	  <td class="a" colspan="3"><h3 align="center">RINGKASAN PELAYANAN PASIEN RAWAT JALAN</h3></td>
	   ...
	   <table>
	  <tr>
	  <td style="width:150px;"><b>Anamnesa</b></td>
	  <td>'.$hasil['keluhan'].'</td>
	  </tr>
	  <tr>
	  <td style="width:150px;"><b>Pemeriksaan</b></td>
	  <td>'.$hasil['pemeriksaan'].'</td>
			...
			<table>
			 ...
			 <table>
				<tr>
				  <td style="width:150px;"><b>Diagnosa</b></td>
	  ...
	  <table>
	  <tr>
				  <td colspan="5"><b>Terapi Obat</b></td>
			  </tr>
	 <tr >
