                    ...
                    <?php } ?>
                        ...
                        ?>
                            <dl class="dl-horizontal">
                                ...
                                <dt>Jenis Kelamin :</dt>
                                <dd><?php echo str_replace("P", "Perempuan", str_replace("L", "Laki-Laki", $data_pasien['jk'])); ?></dd>
                                <dt>Umur :</dt>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                <?php 
                                $q_kunj = query ("SELECT a.tgl_registrasi, b.nm_poli, c.keluhan, c.pemeriksaan, a.no_rawat FROM reg_periksa a, poliklinik b, pemeriksaan_ralan c WHERE a.no_rkm_medis = '$_POST[no_pasien]' AND a.tgl_registrasi BETWEEN '$_POST[tanggal_awal]' AND '$_POST[tanggal_akhir]' AND a.kd_poli = b.kd_poli AND a.no_rawat = c.no_rawat ORDER BY a.tgl_registrasi DESC");
								//$q_kunj = query("SELECT a.tgl_registrasi, b.nm_poli, c.keluhan, c.pemeriksaan, a.no_rawat FROM reg_periksa a, poliklinik b, pemeriksaan_ralan c WHERE a.no_rkm_medis = '064829' AND a.tgl_registrasi BETWEEN '2018-02-02' AND '2018-02-02' AND a.kd_poli = b.kd_poli AND a.no_rawat = c.no_rawat ORDER BY a.tgl_registrasi DESC");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php 
                                            $sql_dx = query("SELECT diagnosa_dr FROM  pemeriksaan_ralan WHERE no_rawat = '$no_rawat'");
                	                        $no=1;
                                        ...
                                        <td>
                                            <ul style="list-style:none;">
                                            <?php 
                                            $sql_dxi = query("SELECT tindakan_dr FROM  pemeriksaan_ralan WHERE no_rawat = '$no_rawat'");
                	                        $no=1;
                                            while ($row_dxi = fetch_array($sql_dxi)) { 
                                                echo '<li>'.$no.'. '.$row_dxi[1].' ('.$row_dxi[0].')</li>';
		                                        $no++;
                                            }              
                                            ?>     
                                            </ul>
                                        ...
                                        <ul style="list-style:none;">
                                            <?php 
                                            $sql_dx = query("SELECT riwayat FROM  pemeriksaan_ralan WHERE no_rawat = '$no_rawat'");
                	                        $no=1;
                                            while ($row_dx = fetch_array($sql_dx)) { 
                                                echo '<li>'.$no.'. '.$row_dx[1].' ('.$row_dx[0].')</li>';
		                                        $no++;
