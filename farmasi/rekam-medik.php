                    ...
                    <?php } ?>
                        ...
                        ?>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                <?php 
                                $q_kunj = query ("SELECT a.tgl_registrasi, b.nm_poli, c.keluhan, c.pemeriksaan, a.no_rawat,c.diagnosa_dr FROM reg_periksa a, poliklinik b, pemeriksaan_ralan c WHERE a.no_rkm_medis = '$_POST[no_pasien]' AND a.tgl_registrasi BETWEEN '$_POST[tanggal_awal]' AND '$_POST[tanggal_akhir]' AND a.kd_poli = b.kd_poli AND a.no_rawat = c.no_rawat");
