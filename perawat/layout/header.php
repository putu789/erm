...
$data=fetch_array(query("SELECT AES_DECRYPT(a.id_user,'nur') as id_user, AES_DECRYPT(a.password,'windi') as password, b.nip as jbtn  from user a, petugas b where a.id_user = AES_ENCRYPT('{$_COOKIE[username]}','nur') and b.nip ='$_COOKIE[username]' and b.kd_jbtn = 'J003'  and a.password = AES_ENCRYPT('{$_COOKIE[password]}','windi') ")); 
...
<head>
    ...
    <title><?php echo $dataSettings['nama_instansi']; ?> - NURSE</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><?php echo $dataSettings['nama_instansi']; ?> - NURSE</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
