 <div class="header">
                ...
                ?>
                        ...
                        <?php
						$select = query("SELECT  e.alergi ,e.keluhan,e.suhu_tubuh,e.tensi,e.nadi,e.respirasi,e.tinggi,e.berat,e.gcs,e.periksa_khusus, e.asesmen_fung,e.nyeri,e.nutrisi,e.perencanaan,e.lila, e.riwayat,e.riwayat_lain,e.pemer,f.mens_pertama,f.siklus,f.lama,f.par_g,f.par_p,f.par_a,f.anak_hidup,f.diag_bid, h.no_rawat, h.kondisi,h.skor,h.kategori FROM reg_periksa a,pemeriksaan_ralan e, pemeriksaan_obg_ralan f, ro g ,resiko_jatuh h WHERE  a.no_rawat ='".$no_rawat."' AND e.no_rawat = '".$no_rawat."' AND f.no_rawat = '".$no_rawat."' AND h.no_rawat = '".$no_rawat."' ");
